...
function UpcomingRipple({ color = 'green' }: { color?: 'green' | 'red' | 'orange' }) {
  ...
  return <NativeAnimated.View pointerEvents="none" style={{ opacity, transform: [{ scale }], borderColor: color === 'red' ? '#dc2626' : color === 'orange' ? '#f59e0b' : '#078a4b', backgroundColor: 'transparent' }} className="absolute h-7 w-7 rounded-full border-2" />;
}
